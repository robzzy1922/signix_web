...
<div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3">
    <a href="{{ route('admin.dokumen.index', ['status' => 'diajukan']) }}"
        class="bg-[#fd7e14] text-white rounded-xl p-6 hover:bg-[#e76b0a] transition-colors duration-200">
    ...
    <a href="{{ route('admin.dokumen.index', ['status' => 'disahkan']) }}"
        class="bg-[#28a745] text-white rounded-xl p-6 hover:bg-[#218838] transition-colors duration-200">
        <div class="flex items-center">
            <div class="p-3 rounded-full bg-white/20">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <a href="{{ route('admin.dokumen.index', ['status' => 'direvisi']) }}"
        class="bg-[#4e73df] text-white rounded-xl p-6 hover:bg-[#4262c5] transition-colors duration-200">
        <div class="flex items-center">
            <div class="p-3 rounded-full bg-white/20">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="overflow-hidden bg-white rounded-xl shadow-lg">
        <div class="flex justify-between items-center p-6 bg-gray-50 border-b border-gray-200">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('admin.ormawa.index') }}"
                    class="px-4 py-2 text-sm font-medium text-blue-600 rounded-lg transition-colors duration-200 hover:text-blue-700 hover:bg-blue-50">
                    Ormawa
                </a>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tabody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                            <div class="flex flex-col items-center">
                                <svg class="mb-2 w-12 h-12 text-gray-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="bg-white rounded-xl shadow-lg">
        <div class="flex justify-between items-center p-6 border-b border-gray-200">
            ...
            <a href="{{ route('admin.dokumen.index') }}"
                class="px-4 py-2 text-sm text-blue-500 hover:text-blue-600 hover:underline">
                Lihat Semua
            </a>
        </div>
        <div class="p-6">
