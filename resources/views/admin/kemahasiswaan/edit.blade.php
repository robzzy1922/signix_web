...
<div class="container px-4 py-8 mx-auto sm:px-6 lg:px-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="{{ route('admin.kemahasiswaan.index') }}" class="ml-1 text-gray-700 hover:text-blue-600 md:ml-2">Kemahasiswaan</a>
                </div>
            </li>
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-gray-500 md:ml-2">Edit Kemahasiswaan</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        <h2 class="mb-6 text-xl font-semibold">Edit Data Kemahasiswaan</h2>
        ...
        <form action="{{ route('admin.kemahasiswaan.update', $kemahasiswaan->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            <div class="mb-4">
                <label for="nama_kemahasiswaan" class="block mb-2 text-sm font-medium text-gray-700">Nama Kemahasiswaan</label>
                <input type="text" name="nama_kemahasiswaan" id="nama_kemahasiswaan"
                       value="{{ old('nama_kemahasiswaan', $kemahasiswaan->nama_kemahasiswaan) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nip" id="nip"
                       value="{{ old('nip', $kemahasiswaan->nip) }}"
                       class="w-full h-10 px-4 border border-gray-300 rounded-md focus:border-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="no_hp" id="no_hp"
                       value="{{ old('no_hp', $kemahasiswaan->no_hp) }}"
                       class="w-full h-10 px-4 border border-gray-300 rounded-md focus:border-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="prodi" id="prodi"
                       value="{{ old('prodi', $kemahasiswaan->prodi) }}"
                       class="w-full h-10 px-4 border border-gray-300 rounded-md focus:border-blue-500">
            </div>
            ...
            <div class="mb-4">
                ...
                @if($kemahasiswaan->profile)
                    <div class="mb-2">
                        <img src="{{ asset('profiles/' . $kemahasiswaan->profile) }}"
                             alt="Profile"
