...
<div class="container px-4 py-8 mx-auto sm:px-6 lg:px-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-gray-500 md:ml-2">Tambah Kemahasiswaan</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        <h2 class="mb-6 text-xl font-semibold">Tambah Kemahasiswaan Baru</h2>
        ...
        <form action="{{ route('admin.kemahasiswaan.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_kemahasiswaan" id="nama_kemahasiswaan" class="w-full h-10 px-4 transition-colors border border-gray-500 rounded-md focus:border-blue-500 focus:ring-2 focus:ring-blue-200" required>
                @error('nama_kemahasiswaan')
