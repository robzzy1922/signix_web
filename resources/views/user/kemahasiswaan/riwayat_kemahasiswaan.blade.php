    ...
    <div class="container flex-grow px-4 mx-auto mt-8 max-w-5xl">
        ...
        <div class="flex flex-col gap-4 mb-4 md:flex-row md:justify-between md:items-center">
            <div class="w-full md:w-64">
                <form method="GET" action="{{ route('kemahasiswaan.riwayat') }}" class="flex">
            ...
            <div class="w-full md:w-auto">
                <form method="GET" action="{{ route('kemahasiswaan.riwayat') }}">
                    <select name="status" class="px-4 py-2 w-full text-sm rounded-lg border md:w-auto" onchange="this.form.submit()">
        ...
        <div class="flex justify-center mt-4">
            ...
            <nav class="inline-flex relative z-0 -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                ...
                <a href="#" class="hidden relative items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 md:inline-flex hover:bg-gray-50">1</a>
                <a href="#" class="hidden relative items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 md:inline-flex hover:bg-gray-50">2</a>
                <a href="#" class="hidden relative items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 md:inline-flex hover:bg-gray-50">3</a>
