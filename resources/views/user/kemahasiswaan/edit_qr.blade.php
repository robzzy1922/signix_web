...
<div class="container px-4 py-8 mx-auto max-w-6xl">
    @if(isset($dokumen))
        ...
        <nav class="flex mb-4" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="{{ route('kemahasiswaan.dashboard') }}" class="inline-flex items-center text-gray-700 hover:text-blue-600">
        ...
        <!-- Add note section -->
        <div class="p-4 mb-4 bg-blue-50 border-l-4 border-blue-400">
    ...
    @else
        <div class="py-8 text-center">
            ...
            <a href="{{ route('kemahasiswaan.dashboard') }}" class="inline-block px-4 py-2 mt-4 text-white bg-blue-500 rounded hover:bg-blue-600">
...
<script>
    ...
    function saveQrPosition(dokumenId) {
        ...
        fetch(`/kemahasiswaan/dokumen/${dokumenId}/save-qr-position`, {
            method: 'POST',
            headers: {
        ...
        .then(data => {
            if (data.success) {
                ...
                window.location.href = '{{ route("kemahasiswaan.dashboard") }}';
            } else {
