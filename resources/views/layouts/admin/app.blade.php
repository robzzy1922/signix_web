...
<body class="bg-gray-100">
    <div x-data class="flex min-h-screen relative">
        <aside class="fixed md:relative bg-[#2A3042] text-white min-h-screen z-40 transition-all duration-300"
            ...
            <div class="p-4">
                ...
                <div class="flex justify-center" x-show="!$store.sidebar.open">
                    <img src="{{ asset('images/logo_signix.png') }}" alt="Logo" class="h-8">
                </div>
            </div>
            <nav class="mt-4">
                <a href="{{ route('admin.adminDashboard') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.adminDashboard') ? 'bg-[#fd7e14] text-white' : 'hover:bg-gray-700' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        :class="$store.sidebar.open ? 'mr-3' : 'mx-auto'" fill="currentColor" viewBox="0 0 16 16">
                        <path
                ...
                <a href="{{ route('admin.dosen.index') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.dosen.*') ? 'bg-[#fd7e14] text-white' : 'hover:bg-gray-700' }}">
                    <svg class="w-5 h-5" :class="$store.sidebar.open ? 'mr-3' : 'mx-auto'" fill="none"
                ...
                <a href="{{ route('admin.kemahasiswaan.index') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.kemahasiswaan.*') ? 'bg-[#fd7e14] text-white' : 'hover:bg-gray-700' }}">
                    <svg class="w-5 h-5" :class="$store.sidebar.open ? 'mr-3' : 'mx-auto'" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                ...
                <a href="{{ route('admin.ormawa.index') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.ormawa.*') ? 'bg-[#fd7e14] text-white' : 'hover:bg-gray-700' }}">
                    <svg class="w-5 h-5" :class="$store.sidebar.open ? 'mr-3' : 'mx-auto'" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                ...
                <a href="{{ route('admin.dokumen.index') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.dokumen.index') ? 'bg-[#fd7e14] text-white' : 'hover:bg-gray-700' }}">
                    <svg class="w-5 h-5" :class="$store.sidebar.open ? 'mr-3' : 'mx-auto'" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.dokumen.report') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.dokumen.report') ? 'bg-[#fd7e14] text-white' : 'hover:bg-gray-700' }}">
                    <svg class="w-5 h-5" :class="$store.sidebar.open ? 'mr-3' : 'mx-auto'"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                    <span x-show="$store.sidebar.open">Laporan Dokumen</span>
                </a>
            </nav>
        </aside>
